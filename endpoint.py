...
def spawn_worker():
    ...
    WORKERS.append(create_ec2(workers_security_group, 'ami-02396cdd13e9a1257', 't2.micro', WORKER_USER_DATA))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="endpoint")
    parser.add_argument("-s", "--sibling", help="sibling endpoint")
    args = parser.parse_args()
    if args.sibling:
        sibling = parser.parse_args().sibling
